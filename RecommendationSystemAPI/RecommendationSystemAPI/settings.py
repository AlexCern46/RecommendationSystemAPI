"""
Django settings for RecommendationSystemAPI project.
...
SECRET_KEY = 'django-insecure-)t6qe16o#zl&h&($7*$x_&u8xumqbi2_ss_jpx*m$)ar!9irk+'
...
ROOT_URLCONF = 'RecommendationSystemAPI.urls'
...
WSGI_APPLICATION = 'RecommendationSystemAPI.wsgi.application'
...
CELERY_BROKER_URL = f"redis://{os.getenv('REDIS_HOST')}:{os.getenv('REDIS_PORT')}/{os.getenv('REDIS_CELERY_DB')}"
